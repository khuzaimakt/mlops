#!/usr/bin/env python
"""Data sourcing for batch inference: load data from SageMaker Feature Store.

This script reads inference data from SageMaker Feature Store offline store
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=4000,
        help="Starting customer_id (inclusive) for inference data",
    )
    parser.add_argument(
        "--customer-id-end",
        type=int,
        default=5000,
        help="Ending customer_id (inclusive) for inference data",
    )
    ...
    try:
        ...
        send_failure_notification("Data Sourcing - Churn Classification Model Batch Pipeline", str(exc))
        raise
